const RUNE_CATALOG = [
  ...
  },
  {
    ...
    name: "Kenaz",
    type: "special",
    description: "If both Kenaz of one owner are in play, all board runes become ethereal for round settlement.",
  ...
  },
  {
    ...
    name: "Dagaz",
    type: "special",
    description: "Copies the rune effect directly below it (can chain through Dagaz).",
  ...
  },
  {
    ...
    name: "Eihwaz",
    type: "special",
    description: "If discarded or removed for the round, its owner gains 1 point from supply.",
  ...
  },
  {
    ...
    name: "Nauthiz",
    type: "special",
    description: "Floats on any free space. Ethereal and cursed (adds 1 Neutral rune to buyer bag when bought).",
